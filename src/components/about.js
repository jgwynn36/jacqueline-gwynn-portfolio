                ...
                <div className="services color-1">
                  ...
                  <div className="desc">
                    ...
                    <p>
                      ...
                      JavaScript, Node, Angular, React, HTML, and CSS.  
                    </p>
                    <p />
                  </div>
                </div>
              ...
              <div className="col-md-4 text-center animate-box">
                <div className="services color-3">
                  ...
                  <div className="desc">
                    ...
                    <p>
                      Troubleshooting issues and providing data is a passion
                      of mine. I enjoy dinging into things and examining if
                      a correlation exist. Understanding business
                      requirements and the customer focus is a strong skill
                      that I poses as I have worked on both ends and can
                      relate to both.
                    </p>
                  </div>
                </div>
              ...
              <div className="col-md-4 text-center animate-box">
                <div className="services color-5">
                  ...
                  <div className="desc">
                    ...
                    <p>
                      I earned my certified scrum master certification and have performed scrum master duties on multiple scrum teams.  I am known for my tell it like it is personality and the ability to influence groups.  I have worked with offshore resources for 6 years.   
                    </p>
                    <p>
                        I have held a quality assurance position for 7 years while performing this role I have been able to manage the project timelines and ensure that quality is built into the application during development.  
                    </p>
                  </div>
                </div>
              </div>
